...
def searching():
	...
	df=pd.read_csv('/home/flask/ubuntu/database.csv')
	images=[]
...
def upload():
	if(request.method=='POST' and request.files['upload']):
		...
		df.to_csv('/home/flask/ubuntu/database.csv',index=False)
		return(render_template("upload.html", filename="../"+src))
...
def delete_images(img_source=""):
	...
	df.to_csv('/home/flask/ubuntu/database.csv', sep=',', encoding='utf-8', index=False)
